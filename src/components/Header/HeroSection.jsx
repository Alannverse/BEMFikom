...
// Preloader Component - Clean & Professional
const ModernPreloader = ({ isLoading }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/95 backdrop-blur-sm">
      <div className="text-center space-y-8">
        ...
        <div className="relative mx-auto w-20 h-20">
          {/* Pulse Ring */}
          <div className="absolute inset-0 border-2 border-cyan-400/40 rounded-full animate-ping"></div>
          
          {/* Rotating Ring */}
          <div className="absolute inset-0 border-2 border-cyan-400 rounded-full animate-spin-slow border-t-transparent"></div>
          
          {/* Logo Center */}
          <div className="absolute inset-2 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-full flex items-center justify-center">
        ...
        <div className="space-y-4">
          ...
          {/* Progress Bar */}
          <div className="w-48 mx-auto bg-white/10 rounded-full h-1.5">
            <div className="bg-gradient-to-r from-cyan-500 to-blue-500 h-1.5 rounded-full animate-pulse"></div>
          </div>
...
const HeroSection = () => {
  ...
  return (
    <>
      <ModernPreloader isLoading={isLoading} />
      
      <header className={`min-h-screen relative flex items-center justify-center px-4 sm:px-6 py-8 lg:py-20 overflow-hidden transition-opacity duration-500 ${isLoading ? 'opacity-0' : 'opacity-100'}`}>
